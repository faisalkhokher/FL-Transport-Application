...
<div class="page-content" id="addNewUser">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            ...
            <a type="button" class="btn btn-primary" href={{route('admin.countries')}}>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-12 mt-12 mt-3">
                                <label for="productname">Country Code*</label>
                                <input type="text" name="country_code" id="productname" class="form-control"
